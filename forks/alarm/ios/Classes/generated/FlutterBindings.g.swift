...
struct NotificationSettingsWire: Hashable {
  ...
  var snoozeDurationMinutes: Int64
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NotificationSettingsWire? {
    ...
    let snoozeDurationMinutes = pigeonVar_list[10] as! Int64
...
protocol AlarmTriggerApiProtocol {
  ...
  func alarmSnoozed(alarmId alarmIdArg: Int64, completion: @escaping (Result<Void, PigeonError>) -> Void)
}
