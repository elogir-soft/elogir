import 'package:elogir_calc/layout/breakpoints.dart';
import 'package:elogir_calc/shared/widgets/nav_icons.dart';
...
class AppShell extends StatelessWidget {
  ...
  static const _destinations = [
    _NavDestination(path: '/calculator', label: 'Calculator'),
    _NavDestination(path: '/history', label: 'History'),
  ];
