...
class ElogirColorPalette {
  const ElogirColorPalette({
    this.primary50 = const Color(0xFFEFF6FF),
    this.primary100 = const Color(0xFFDBEAFE),
    this.primary200 = const Color(0xFFBFDBFE),
    this.primary300 = const Color(0xFF93C5FD),
    this.primary400 = const Color(0xFF60A5FA),
    this.primary500 = const Color(0xFF3B82F6),
    this.primary600 = const Color(0xFF2563EB),
    this.primary700 = const Color(0xFF1D4ED8),
    this.primary800 = const Color(0xFF1E40AF),
    this.primary900 = const Color(0xFF1E3A8A),
